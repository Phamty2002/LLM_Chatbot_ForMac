...
# Xác định thiết bị: ưu tiên MPS, nếu không có thì fallback về CPU
...
try:
    ...
    # Sử dụng float32 cho mọi trường hợp
    if device.type == "mps":
    ...
    logger.info(f"Loaded model '{model_name}' using dtype float32.")
except Exception as e:
...
try:
    ...
    # Load SentenceTransformer trên cùng device
